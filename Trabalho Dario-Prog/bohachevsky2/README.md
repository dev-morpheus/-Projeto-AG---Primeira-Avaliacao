# Trabalho avaliativo - Algoritmo Genético Função Bohachevsky 2 (BC2)
## Aluno: Vitor dos Santos Correia
<br>

### BF2: f(x) = x1² + 2x2² - 0.3 * cos(3 * pi * x1) * cos(4 * pi * x2) + 0.3

<br>

### Tabela Comparativa

| BF2 | Ali 2010 | Kaela 2007 | Vitor 2026 |
| :--- | :---: | :---: | :---: |
| NFE | 2.786 | 1.254 | 83.600 |
| SR | 98 | 100 | 100 |

- ### Fitness: Representação real direta da função de Bohachevsky 2. O ótimo global é 0 na origem.
